...
<head>
    ...
    <title>Tabel Driver - SIKEPIK Admin</title>
    ...
    <div class="flex">
        ...
        <aside class="w-1/4 bg-gray-800 text-white h-screen">
            ...
            <nav class="mt-10">
                ...
                <div class="py-2 px-4">
                    ...
                    <a href="{{ route('admin.mobil.index') }}" class="block pl-4 py-1 hover:bg-gray-700">Tabel Mobil</a>
                    <a href="{{ route('admin.mobil.create') }}" class="block pl-4 py-1 hover:bg-gray-700">Tambah Mobil</a>
                </div>
                <div class="py-2 px-4">
        ...
        <main class="flex-1 p-8">
            ...
            <div class="text-sm text-gray-500 mb-4">
                <span>Driver</span> &gt; <span class="font-semibold text-blue-600">Tabel Driver</span>
            </div>

            <!-- Table Header -->
            <h1 class="text-2xl font-semibold mb-6">Tabel Driver</h1>
                    ...
                    @foreach($drivers as $index => $driver)
                        <tr>
                            ...
                            <td class="py-4 px-4 border-b text-center">
                                <img src="{{ $driver->image_url }}" alt="Driver Image" class="w-12 h-12 rounded-full">
                            </td>
                            <td class="py-4 px-4 border-b">{{ $driver->name }}</td>
                            <td class="py-4 px-4 border-b">{{ $driver->email }}</td>
                            <td class="py-4 px-4 border-b">{{ $driver->phone }}</td>
                            <td class="py-4 px-4 border-b text-center">
                                <a href="{{ route('admin.drivers.edit', $driver->id) }}" class="px-4 py-2 bg-blue-500 text-white rounded-md text-sm">Edit</a>
